...
def auth_logout():
    session.clear()
    # Redirect to our own login page — user clicks "Continue with Atlassian" themselves
    # prompt=login is passed when they click login, so Atlassian asks for password
